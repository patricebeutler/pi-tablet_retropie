...
# Permissions 
sudo chmod -R 755 /home/pi/patricebeutler/assets/*
sudo chown pi:pi /home/pi/patricebeutler
sudo chown pi:pi /home/pi/patricebeutler/*
...
cd /home/pi/patricebeutler/assets/
sudo mv "/home/pi/patricebeutler/assets/autologin@.service" "/etc/systemd/system/autologin@.service"
sudo mv "/home/pi/patricebeutler/assets/autostart.sh" "/opt/retropie/configs/all/autostart.sh"
